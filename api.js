...
//     var query = ["START n=node(" + nodeId + " ) ", "MATCH n-[r]-()  ", "DELETE r"].join("\n");
...
//   neo4j.connect(neo4JUrl, function(err, graph) {
//     if (err) throw err;
//     var query = ["START n=node(" + startNodeId + "), m=node(" + endNodeId + ")", "CREATE UNIQUE (n)-[:" + relationshipName + "]->(m)"].join("\n");
